...
// Pinning: TX_PIN -> D13 (fast port toggle), POWER_PIN -> any digital output to switch PC (3.3V)
// Serial commands:
//  F - toggle Forward
...
#define TX_PIN 13       // пин на выход DOUT
#define POWER_PIN 12    // пин для подачи 3.3V на PC микросхемы
